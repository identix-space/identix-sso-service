...
import { NestedEnumOAuthProviderWithAggregatesFilter } from './nested-enum-o-auth-provider-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumOAuthProviderFilter } from './nested-enum-o-auth-provider-filter.input';

@InputType()
export class EnumOAuthProviderWithAggregatesFilter {
